...
class DremioDialect_pyodbc(PyODBCConnector, DremioDialect):
    ...
    driver_for_platform = {
        'Linux 64bit': '/opt/arrow-flight-sql-odbc-driver/lib64/libarrow-odbc.so.0.9.1.168',
        'Linux 32bit': '/opt/arrow-flight-sql-odbc-driver/lib64/libarrow-odbc.so.0.9.1.168',
        'Windows': 'Apache Arrow Flight SQL',
